...
#python main.py --json_path=ihdp/diffPOihdp-lowdiff.json --UC=0 --CD=10 --M=3 --signals=IPCW
#python main.py --json_path=ihdp/diffPOihdp-lowdiff.json --UC=0 --CD=10 --M=3 --signals=CDR
#python main.py --json_path=ihdp/diffPOihdp-lowdiff.json --UC=0 --CD=10 --M=3 --signals=CDR-MissG
#python main.py --json_path=ihdp/diffPOihdp-lowdiff.json --UC=0 --CD=10 --M=3 --signals=CDR-MissF
#python main.py --json_path=ihdp/diffPOihdp-lowdiff.json --UC=0 --CD=10 --M=3 --signals=IPW-Impute
#python main.py --json_path=ihdp/diffPOihdp-lowdiff.json --UC=0 --CD=10 --M=3 --signals=IPW-Drop
#python main.py --json_path=ihdp/diffPOihdp-lowdiff.json --UC=0 --CD=10 --M=3 --signals=DR-Impute
#python main.py --json_path=ihdp/diffPOihdp-lowdiff.json --UC=0 --CD=10 --M=3 --signals=DR-Drop

#python main.py --json_path=ihdp/diffPOihdp-highdiff.json --UC=0 --CD=10 --M=3 --signals=IPCW
#python main.py --json_path=ihdp/diffPOihdp-highdiff.json --UC=0 --CD=10 --M=3 --signals=CDR
#python main.py --json_path=ihdp/diffPOihdp-highdiff.json --UC=0 --CD=10 --M=3 --signals=CDR-MissG
#python main.py --json_path=ihdp/diffPOihdp-highdiff.json --UC=0 --CD=10 --M=3 --signals=CDR-MissF
#python main.py --json_path=ihdp/diffPOihdp-highdiff.json --UC=0 --CD=10 --M=3 --signals=IPW-Impute
#python main.py --json_path=ihdp/diffPOihdp-highdiff.json --UC=0 --CD=10 --M=3 --signals=IPW-Drop
#python main.py --json_path=ihdp/diffPOihdp-highdiff.json --UC=0 --CD=10 --M=3 --signals=DR-Impute
#python main.py --json_path=ihdp/diffPOihdp-highdiff.json --UC=0 --CD=10 --M=3 --signals=DR-Drop
...
#python main.py --json_path=ihdp/samePOihdp-lowhc.json --UC=1 --CD=10 --M=3 --signals=IPCW
#python main.py --json_path=ihdp/samePOihdp-lowhc.json --UC=1 --CD=10 --M=3 --signals=CDR
#python main.py --json_path=ihdp/samePOihdp-lowhc.json --UC=1 --CD=10 --M=3 --signals=CDR-MissG
#python main.py --json_path=ihdp/samePOihdp-lowhc.json --UC=1 --CD=10 --M=3 --signals=CDR-MissF
#python main.py --json_path=ihdp/samePOihdp-lowhc.json --UC=1 --CD=10 --M=3 --signals=IPW-Impute
#python main.py --json_path=ihdp/samePOihdp-lowhc.json --UC=1 --CD=10 --M=3 --signals=IPW-Drop
#python main.py --json_path=ihdp/samePOihdp-lowhc.json --UC=1 --CD=10 --M=3 --signals=DR-Impute
#python main.py --json_path=ihdp/samePOihdp-lowhc.json --UC=1 --CD=10 --M=3 --signals=DR-Drop

#python main.py --json_path=ihdp/samePOihdp-highhc.json --UC=1 --CD=10 --M=3 --signals=IPCW
#python main.py --json_path=ihdp/samePOihdp-highhc.json --UC=1 --CD=10 --M=3 --signals=CDR
#python main.py --json_path=ihdp/samePOihdp-highhc.json --UC=1 --CD=10 --M=3 --signals=CDR-MissG
#python main.py --json_path=ihdp/samePOihdp-highhc.json --UC=1 --CD=10 --M=3 --signals=CDR-MissF
#python main.py --json_path=ihdp/samePOihdp-highhc.json --UC=1 --CD=10 --M=3 --signals=IPW-Impute
#python main.py --json_path=ihdp/samePOihdp-highhc.json --UC=1 --CD=10 --M=3 --signals=IPW-Drop
#python main.py --json_path=ihdp/samePOihdp-highhc.json --UC=1 --CD=10 --M=3 --signals=DR-Impute
#python main.py --json_path=ihdp/samePOihdp-highhc.json --UC=1 --CD=10 --M=3 --signals=DR-Drop
